...
require_once('../../public/TCPDF-main/tcpdf.php'); // Si usas Composer
...
// require_once('path/to/tcpdf.php'); // Si descargas TCPDF manualmente
...
$rectWidth = $pageWidth; // Ancho del rectángulo (todo el ancho de la página menos márgenes)
...
// Establecer color de relleno (azul) y transparencia
$pdf->SetFillColor(128, 0, 128); // Morado RGB
$pdf->SetAlpha(0.2); // Ajustar la transparencia (0.0 es completamente transparente, 1.0 es opaco)
...
<b>Fecha y Hora Emisión:</b> '.$fechahora.'<br>
<b>Moneda:</b> GTQ 
...
// Cerrar y enviar PDF
$pdf->Output('Constancia-Mensualidad-'.$fechahora.'.pdf', 'I'); // 'I' para visualizar en el navegador
?>
