...
<div class="custom-main custom-sidebar-active">
    ...
    if ($rol_sesion_usuario == "ESTUDIANTE") {
        ...
        <div class="top-image-bxx">
            <img src="../public/img/logo_letra.png" alt="Logo" class="top-image">
        </div>
        ...
        <div class="wrapper">
            ...
            <ul class="carousel">
                ...
                <a href="#" class="card">
                    <div class="img"><img src="../public/img/img7.png" alt="" draggable="false"></div>
                    <h2>Videos</h2>
                </a>
                <a href="<?= APP_URL; ?>/admin/estudiantes/class_topics.php" class="card">
                    <div class="img"><img src="../public/img/milaneso.png" alt="" draggable="false"></div>
                    <h2>Class Topics</h2>
                </a>
                <a href="#" class="card">
                    <div class="img"><img src="../public/img/img4.png" alt="" draggable="false"></div>
                    <h2>Just kids Tv</h2>
                </a>
                <a href="#" class="card">
                    <div class="img"><img src="../public/img/img6.png" alt="" draggable="false"></div>
                    <h2>Books</h2>
                </a>
                <a href="#" class="card">
                    <div class="img"><img src="../public/img/img5.png" alt="" draggable="false"></div>
                    <h2>Listening</h2>
                </a>
            </ul>
