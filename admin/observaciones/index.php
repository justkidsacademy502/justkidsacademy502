                            ...
                            foreach ($asignaciones as $asignacione) {
                                ...
                                if ($email_sesion == $asignacione['email']) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center><a href="create.php?id_grado=<?= $id_grado; ?>&&id_docente=<?= $asignacione['docente_id']; ?>&&id_materia=<?= $asignacione['materia_id']; ?>" class="btn btn-danger btn-sm"><i class="bi bi-check2-square"></i> Subir Observación</a></center>
                                        </td>
                                    </tr>
                            <?php
                                }
                            ...
                            foreach ($asignaciones as $asignacione) {
                                ...
                                if ($email_sesion == $asignacione['email']) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center><a href="create_diploma.php?id_grado=<?= $id_grado; ?>&&id_docente=<?= $asignacione['docente_id']; ?>&&id_materia=<?= $asignacione['materia_id']; ?>" class="btn bg-orange btn-sm"><i class="bi bi-check2-square"></i> Subir Diploma</a></center>
                                        </td>
                                    </tr>
                            <?php
                                }
